...
class RoboFile extends \Robo\Tasks
{
    ...
    {
        $tasks = [];
        $tasks[] = $this->taskExec('docker-compose exec -T cypress ls -la');
        $tasks[] = $this->taskExec('docker-compose exec -T cypress curl http://apache');
        $tasks[] = $this->taskExec('docker-compose exec -T cypress npm init -y && npm install cypress --save-dev && $(npm bin)/cypress run');
        return $tasks;
    }

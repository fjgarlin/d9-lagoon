...
class RoboFile extends \Robo\Tasks
{
    ...
    {
        $tasks = [];
        $tasks[] = $this->taskExec('docker-compose exec -T cypress npm install cypress --save-dev --unsafe-perm');
        $tasks[] = $this->taskExec('docker-compose exec -T cypress $(npm bin)/cypress run');
        return $tasks;
    }
